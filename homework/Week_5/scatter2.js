...
// var requests = [d3.json(msti.json), d3.json(consconf.json)];

// d3.json("consconf.json").then(function(root) {
...
//     dataset2 = response[1]
    ...
    // newData2 = transformResponse(dataset2)
    var newData2 = root

    // d3.json("msti.json").then(function(root2) {
    var newData1 = root2
